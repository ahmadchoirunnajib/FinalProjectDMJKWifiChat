...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mWifi.isConnected()) {
            showAlert("Error", "WiFi tidak terjangkau! Pastikan WiFi Menyala!");
        }
        ...
        toolbar.setTitle("AG Wi-Fi Chat");
    ...
    private void shareIntentMethod() {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, "Ingin bisa Chatting melalui Jaringan WiFi? " +
                "Download AG WiFi, Aplikasi Chatting melalui WiFi masa kini :v \n" + urlaplikasi);
        startActivity(Intent.createChooser(shareIntent, "Bagikan AG WiFi melalui"));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_help) {
            ...
            builder.setTitle("How to Use")
                    .setMessage("Turn on WiFi, connect to same Access Point")
                    .setCancelable(false)
